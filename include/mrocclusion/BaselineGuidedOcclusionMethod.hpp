#ifndef MROCCLUSION_BASELINEGUIDEDOCCLUSIONMETHOD_HPP_INCLUDED
#define MROCCLUSION_BASELINEGUIDEDOCCLUSIONMETHOD_HPP_INCLUDED

#include <mrocclusion/RgbdOcclusionMethod.hpp>

class BaselineGuidedOcclusionMethod : public RgbdOcclusionMethod {
public:
	BaselineGuidedOcclusionMethod(
		size_t colorWidth, size_t colorHeight,
		size_t depthWidth, size_t depthHeight);

	virtual ~BaselineGuidedOcclusionMethod() throw();
...
private:
	BaselineGuidedOcclusionMethod(const BaselineGuidedOcclusionMethod&);
	BaselineGuidedOcclusionMethod& operator=(const BaselineGuidedOcclusionMethod&);
};
